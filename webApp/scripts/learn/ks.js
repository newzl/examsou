'use strict';
layui.config({ base: '/scripts/learn/' }).use(['element', 'laypage', 'laytpl', 'globalsx'], function () {
    var element = layui.element, laypage = layui.laypage, laytpl = layui.laytpl, globalsx = layui.globalsx;
    $(function () {
        ...
        getBase(function (bres) {
            globalsx.getlearnks({
                ...
                laytpl(collaTpl.innerHTML).render(res.data, function (htm) {
                    document.getElementById('collaView').innerHTML = htm;
