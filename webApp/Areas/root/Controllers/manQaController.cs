...
namespace webApp.Areas.root.Controllers
{
    ...
    public class manQAController : Controller
    {
        //
        // GET: /root/manqa/
        ...
        {
            return View(BLL.root.subksBLL.getEntity(id, "qa"));
        }
        #endregion
        ...
        public void listdata()
        {
            try
            {
                ...
                {
                    table = "QASubject k join subjectClass s on k.SubjectClassID=s.ID",
        ...
        public int save(Models.subks m)
        {
            ...
            return BLL.root.subksBLL.save(m, "qa");
        }
        //修改入库状态
        [HttpPost]
        public int instate(int id, bool state)
        {
            BLL.root.subksBLL.inState(id, state, "qa");
            return 1;
        }
        [HttpGet]
        public JsonResult getentity(int id)
        {
            return Json(BLL.root.subksBLL.getEntity(id, "qa"), JsonRequestBehavior.AllowGet);
        }
        #endregion
