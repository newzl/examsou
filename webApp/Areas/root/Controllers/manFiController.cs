...
namespace webApp.Areas.root.Controllers
{
    ...
    public class manFiController : Controller
    {
        //
        // GET: /root/manFi/
        #region view
        ...
        {
            return View(BLL.root.subksBLL.getEntity(id, "fi"));
        }
        #endregion
        ...
        public void listdata()
        {
            try
            {
                ...
                {
                    table = "FillVacancySubject k join subjectClass s on k.SubjectClassID=s.ID",
        ...
        public int save(Models.subks m)
        {
            ...
            return BLL.root.subksBLL.save(m, "fi");
        }
        //修改入库状态
        [HttpPost]
        public int instate(int id, bool state)
        {
            BLL.root.subksBLL.inState(id, state, "fi");
            return 1;
        }
        [HttpGet]
        public JsonResult getentity(int id)
        {
            return Json(BLL.root.subksBLL.getEntity(id, "fi"), JsonRequestBehavior.AllowGet);
        }
        #endregion
    }
}
