...
namespace webApp.Areas.root.Controllers
{
    ...
    public class manMcController : Controller
    {
        //
        // GET: /root/manMc/
        #region view
        ...
        {
            return View(BLL.root.subksBLL.getEntity(id, "mc"));
        }
        #endregion
        ...
        public void listdata()
        {
            try
            {
                ...
                {
                    table = "MCJXSubject k join subjectClass s on k.SubjectClassID=s.ID",
        ...
        public int save(Models.subks m)
        {
            ...
            return BLL.root.subksBLL.save(m, "mc");
        }
        //修改入库状态
        [HttpPost]
        public int instate(int id, bool state)
        {
            BLL.root.subksBLL.inState(id, state, "mc");
            return 1;
        }
        [HttpGet]
        public JsonResult getentity(int id)
        {
            return Json(BLL.root.subksBLL.getEntity(id, "mc"), JsonRequestBehavior.AllowGet);
        }
        #endregion
    }
}
