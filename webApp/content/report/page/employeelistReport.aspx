<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employeelistReport.aspx.cs" Inherits="webApp.content.report.page.employeelistReport" %>
<!DOCTYPE html>
...
<body onload="window_onload()">
    <script type="text/javascript">
        var Report = '/content/report/grf/employeelist.grf?v=20171021';
        var Data = '/content/report/data/employeelistData.aspx' + window.location.search;
